...
is $fake->last_call->{path}, '/downloadQueue', 'create path';
...
is $fake->last_call->{path}, '/downloadQueue/42/add', 'add path';
...
is $fake->last_call->{path}, '/downloadQueue/42/items/7/restart', 'restart_item path';
